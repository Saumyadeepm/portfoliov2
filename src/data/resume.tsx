...
export const DATA = {
  ...
  active: true,
  description:
      "Developed a basic web browser using Python and PyQt5, featuring a user-friendly interface with support for 5+ tabs. Implemented key navigation functions, enhancing user efficiency by 40%. Designed an intelligent URL bar and SSL status indication, providing improved accessibility and security awareness.",
  technologies: [
    "Python",
    "PyQt5",
    "HTML",
